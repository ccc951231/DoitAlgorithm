...
public class Max3m {
	...
	public static void main(String[] args) {
		System.out.println("max3(3,2,1) = " + max3(3,2,1)); // max3의 메소드를 가지고 int형 매개변수 a,b,c의 값을 받아 
		System.out.println("max3(3,2,2) = " + max3(3,2,2)); // 최댓값을 구하고 다시 메인메소드에 int형으로 값을 반환한다.
